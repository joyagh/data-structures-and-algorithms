...
const addValues = (arr) => {
  let newValue = 0;
  return arr.reduce((total, value) => total + value, newValue);
};
...
const addPurchases = (arr) => {
  return arr.reduce((totalVal, item) => item.purchasePrice + totalVal, 0);
};
...
const returnNames = (arr) => {
  return arr.reduce((newArray, names) => {
